                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-12 col-sm-12 col-12">
                            <div className="footer_left_side">
                                <Link  to="/" ><img className="f_img" src={logo} alt="logo" /></Link>
                                <p>
                                    <strong>rentOcart</strong>is India's one and only marketplace which focuses on renting of all consumer durables and appliances that are needed in every household. 
                    ...
                    <div className="row">
                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
                            <div className="copyright_left">
                                <h6>© CopyRight 2022 <span>rentOcart</span></h6>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-6 col-12">
