                                        ...
                                        show === "shop" ? <>
                                            ...
                                            <ul className="mobile-sub-menu">
                                                <li>
                                                    <a href="#!">Shop Pages</a>
                                                    <ul className="mobile-sub-menu">
                                                        <li><Link to="/cart">Cart View head</Link></li>
            ...
            <div id="offcanvas-about" className="offcanvas offcanvas-rightside offcanvas-mobile-about-section">
                ...
                <div className="mobile-contact-info">
                    <address className="address">
                        ...
                        <span>Address: WareShare Technologies Pvt Ltd ,Technopolis Building,11th Floor-awfis,Bp4, SectorV, Salt Lake City,Bidhannagar,Kolkata, West Bengal, 700091.</span>
                        <br></br>
                        <span>Call Us: +919330391968</span>
                        <br></br>
                        <span>Email: support@rentocart.com </span>
                    </address>
                    <ul className="social-link">
                        <li>
                            <a href="#!"><i className="fa fa-facebook"></i></a>
